...
my_ellipse = ellipse(f_point=(400, 400), win_size=(800, 800), r_k=0.01)
my_ellipse2 = ellipse(f_point=(400, 400), win_size=(800, 800), r_k=0.01)
my_ellipse3 = ellipse(f_point=(400, 400), win_size=(800, 800), r_k=0.01)
my_ellipse.set_v()
my_ellipse2.set_v()
